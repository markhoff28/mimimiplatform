...
<div class="page-content">
  ...
  <div class="card">
    <div class="card-body p-4">
      ...
      <form id="myForm" action="{{ route('roles.permission.update',$role->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
          <div class="col-3">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="" id="{{ $group->group_name }}" {{ App\Models\User::roleHasPermissions($role,$permissions) ? 'checked' : '' }}>
